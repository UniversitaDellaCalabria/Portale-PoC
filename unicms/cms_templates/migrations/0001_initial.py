    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('template_file', models.CharField(choices=[('publication_list.html', 'publication_list.html'), ('publication_view.html', 'publication_view.html'), ('portale_home_v1.html', 'portale_home_v1.html'), ('portale_home_v_original.html', 'portale_home_v_original.html'), ('portale_home_v3.html', 'portale_home_v3.html'), ('portale_home_v2.html', 'portale_home_v2.html')], max_length=1024)),
                ('note', models.TextField(blank=True, help_text='Editorial Board Notes, not visible by public.', null=True)),
                ('blocks', models.ManyToManyField(blank=True, to='cms_templates.PageBlockTemplate')),
            ],
            options={
