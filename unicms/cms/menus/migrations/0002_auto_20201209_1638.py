...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, help_text='Takes additional contents from a publication', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='inherited_content', to='cmspages.publication'),
        ),
        migrations.AddField(
            model_name='navigationbaritem',
            name='menu',
        ...
        migrations.AddField(
            model_name='navigationbaritem',
            name='publication',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='pub', to='cmspages.publication'),
        ),
        migrations.AddField(
            model_name='navigationbaritem',
            name='webpath',
